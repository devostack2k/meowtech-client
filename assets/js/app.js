  ...
  var axilInit = {
    ...
    contactForm: function () {
      $(".axil-contact-form").on("submit", function (e) {
        ...
        var data = _self.serializeArray().reduce((objectValue, item) => {
          objectValue[item.name] = item.value;
          return objectValue;
        }, {});
          ...
          .done(function (data) {
            ...
            if (data.code === false) {
              ...
              _self
                .find(".btn-primary")
                .after(
                  '<div class="success-msg"><p style="font-size:18px">' +
                    data.success +
                    "</p></div>"
                );
    ...
    emailForm() {
      $(".axil-email-form").on("submit", function (e) {
        e.preventDefault();
        var _self = $(this);
